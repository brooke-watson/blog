---
title: Scraping Javascript websites in R
...
tags:
  ...
  - package development
  - Github
description: "Using PhantomJS to scrap audio files from therapboard.com. This was the preliminary work necessary to create BRRR, an R package for audio notifications worthy of Gucci Mane."
---
...
library(tidyverse)
filtered_names = read_csv("../data/2018-03-17-scraping-javascript-websites-in-r/filtered_names.csv")
```
...
![](/figs/2018-03-17-scraping-javascript-websites-in-r/inst.png)
...
![](/figs/2018-03-17-scraping-javascript-websites-in-r/gucci-nevertoolate.png)
